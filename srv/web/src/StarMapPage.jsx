...
import {
  ...
  MAP_PLANET_CATEGORIES,
  MAP_PLANET_UNKNOWN_BADGE,
  MapPlanetCategoryIcon,
  PlanetCategoryBadge,
  planetCategoryForKey,
} from "./planetCategoryIcons.jsx";
          ...
          <div className="map-system-drill-body">
            ...
            <React.Suspense fallback={<section className="panel system-preview-panel system-preview-loading">Loading System Simulation...</section>}>
              <SystemPreviewPanel
                ...
                onPlanetCategoryEntries={setDrillPlanetCategoryEntries}
