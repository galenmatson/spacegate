...
def summarize_cook_stage(state_dir: Path) -> dict:
    cooked_specs = [
        ...
        ("sb9_systems", "cooked/sb9/sb9_systems.csv"),
        ("sb9_aliases", "cooked/sb9/sb9_aliases.csv"),
        ("sb9_orbits", "cooked/sb9/sb9_orbits.csv"),
        ...
        ("tess_eb", "cooked/tess_eb/tess_eb_catalog.csv"),
        ("nasa_toi", "cooked/tess_evidence/toi.csv"),
        ("tess_target_set", "cooked/tess_evidence/target_tic_ids.csv"),
        ("mast_tic_targeted", "cooked/tess_evidence/targeted_tic.csv"),
        ("gaia_dr2_neighbourhood_targeted", "cooked/tess_evidence/gaia_dr2_neighbourhood.csv"),
        ("gaia_external_crossmatches", "cooked/tess_evidence/gaia_external_crossmatches.csv"),
        ("gaia_dr3_targets", "cooked/tess_evidence/gaia_dr3_targets.csv"),
