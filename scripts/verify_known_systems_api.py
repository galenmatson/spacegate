...
BENCHMARKS: tuple[BenchmarkCase, ...] = (
    BenchmarkCase(
        ...
        required_hierarchy_facts=(
            ...
            HierarchyFact("Castor AB", {"spectral_type_raw": "M2-M3", "spectral_class": "M", "mass_msun": 0.39}),
            HierarchyFact("Castor BB", {"spectral_type_raw": "M2-M3", "spectral_class": "M", "mass_msun": 0.39}),
            HierarchyFact("Castor CB", {"spectral_type_raw": "early-M", "spectral_class": "M", "mass_msun": 0.6}),
        ),
        min_scene_stars=6,
    ),
    BenchmarkCase(
