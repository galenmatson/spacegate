...
- [x] Admin v2 Object Diagnostics first pass with system dossiers, member focus diagnostics, coolness contribution explanation, and read-only relation diagram
