...
- [x] E7 completion audit checkpoint: verify 85 pinned reports/artifacts with no
...
- [x] E7 selected-system placement projection: place all 5,869,091 canonical
...
- [x] E7 clean identity/search foundation: compile build
  `9c2d08086275ead386f71bf7` from pinned identity, alias, hierarchy, and selected
  placement artifacts without opening a stability database; preserve all
  5,869,091 systems, 5,874,636 stars, and 6,311 planets, emit 12,768,410
  deterministic search terms, independently verify the query databases, and
  reproduce every canonical Parquet hash in isolated scratch
- [x] E7 clean selected-science projection: compile build
  `35eb29fa3b2a3ac518f5303a` from the clean foundation and all eight accepted E5
  artifact families without stability values; materialize selected stellar and
...
- [x] E4 Cantat-Gaudin supplementary cluster evidence: preserve all 2,017
