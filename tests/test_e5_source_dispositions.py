...
def test_e5_disposition_audit_requires_cluster_artifact_lineage() -> None:
    release_set = {
        "schema_version": "spacegate.scientific_evidence_release_set.v1",
        "release_set_id": "set1",
        "status": "pass",
    ...
    dispositions = {
        ...
        "explicit_dispositions": {
            "source": {
                "disposition": "selected_cluster_evidence_projection",
                "owner": "E5",
                "blocks_e5": False,
                "reason": "missing required artifact lineage",
            }
...
def test_e5_disposition_audit_requires_extended_object_artifact_lineage() -> None:
    release_set = {
        "schema_version": "spacegate.scientific_evidence_release_set.v1",
        "release_set_id": "set1",
        "status": "pass",
...
def test_e5_disposition_audit_requires_planet_artifact_lineage() -> None:
    release_set = {
        "schema_version": "spacegate.scientific_evidence_release_set.v1",
        "release_set_id": "set1",
        "status": "pass",
    ...
    dispositions = {
        ...
        "explicit_dispositions": {
            "source": {
                "disposition": "selected_planet_evidence_projection",
                "owner": "E5",
                "blocks_e5": False,
                "reason": "missing required artifact lineage",
            }
